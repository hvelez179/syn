...
data class DHPMobileDeviceInfo (
    var externalEntityID: String? = null,
    @Transient override val dhpObjectName: String = "mobile_device_info",
    ...
    var OSInfo: DHPCodes.OSInfo = DHPCodes.OSInfo.android
